...
export function SpotInterface({ cryptocurrencies }: { cryptocurrencies: Cryptocurrency[] }) {
  ...
  return (
    <Card className="w-full max-w-md shadow-2xl shadow-primary/10">
      <CardHeader className="relative text-center">
        <CardTitle>Spot Trade</CardTitle>
        <CardDescription>Trade tokens at the current market rate</CardDescription>
        <Popover>
      ...
      <CardFooter className="flex-col gap-4">
        <div className="w-full">
            {isWalletConnected ? (
               <Button className="w-full h-12 text-lg">Trade</Button>
            ) : (
                <WalletConnect>
