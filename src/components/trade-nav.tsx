...
export function TradeNav() {
  ...
  const activeTabClass = "data-[state=active]:bg-card data-[state=active]:text-card-foreground dark:data-[state=active]:bg-primary dark:data-[state=active]:text-primary-foreground";
